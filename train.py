...
from gcbfplus.stl.utils import TRAINING_CONFIG
...
def train(args):
    ...
    # create environments (the low-level controller trains on the bare env: STL planning
    # happens at evaluation time, in test.py)
    env = make_env(
        env_id=args.env,
...
def train_args():
    ...
    parser.add_argument("--env", type=str, default="DubinsCar")
