...
class GraphsTuple(tuple, Generic[_State, _EnvState]):
    ...
    def __new__(
        ...
        # aux_nodes is deliberately left out of the raw tuple: the underlying tuple keeps the
        # legacy 14-field layout so positional unpacking / indexing of a GraphsTuple still
        # works. tree_flatten_with_keys iterates over the annotated fields instead, so
        # aux_nodes IS part of the pytree and survives jit/vmap/tree_map.
        tup = (
